...
----------------------------------------------------------------------*/
define("MYSQL_ADDRESS", "数据库host");          // Define the IP address of your MySQL Server
define("MYSQL_USERNAME", "数据库账号");         // Define your MySQL user name
define("MYSQL_PASSWORD", "数据库密码");         // Define your MySQL password
define("DATABASE", "数据库名称");               // Define your default database
